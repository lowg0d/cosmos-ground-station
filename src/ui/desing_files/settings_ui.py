...
"}")
        ...
        self.horizontalLayout_6.addWidget(self.label_config_name)
        self.restart = QtWidgets.QLabel(self.frame_2)
        self.restart.setStyleSheet("color: rgb(170, 0, 0);")
        self.restart.setObjectName("restart")
        self.horizontalLayout_6.addWidget(self.restart)
        self.verticalLayout_3.addWidget(self.frame_2)
        self.description_label = QtWidgets.QLabel(self.frame)
        self.description_label.setMinimumSize(QtCore.QSize(200, 0))
...
"    border-radius: none;}")
        ...
        self.folder = QtWidgets.QPushButton(self.widgetcontainer)
        self.folder.setMinimumSize(QtCore.QSize(190, 33))
        self.folder.setMaximumSize(QtCore.QSize(190, 33))
...
"border-bottom-right-radius: 4px;")
    ...
    def retranslateUi(self, SettingsForm):
        ...
        self.restart.setText(_translate("SettingsForm", "NEED RESTART TO APLY !!"))
        self.description_label.setText(_translate("SettingsForm", "Description"))
        self.folder.setText(_translate("SettingsForm", "FOLDER"))
